          ...
          <div>
            ...
            <div className="mt-20">
              ...
              <p className="mt-5 text-blue-100 leading-relaxed max-w-sm">
                Create your ShopKart account and discover products you'll love,
                manage your cart, and enjoy a smoother shopping experience.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-md mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className="w-full rounded-lg bg-blue-600 py-3 px-4 text-sm font-semibold text-white shadow-lg shadow-blue-600/20 hover:bg-blue-700 transition disabled:bg-gray-600 disabled:text-gray-400 disabled:shadow-none disabled:cursor-not-allowed"
              >
                Create account
              </button>
            </form>
